...
import {CovenantVaultV3} from "./CovenantVaultV3.sol";

/// @title CovenantVaultFactoryV2
/// @notice Self-serve creation of Covenant Accounts. Anyone can call
///         `createVault(mandate)` and get a fresh, immutable `CovenantVaultV3`
...
///         pausing. It is a thin discovery layer over `CovenantVaultV3`'s
///         constructor.
contract CovenantVaultFactoryV2 {
    ...
    function createVault(CovenantVault.Mandate memory m) external returns (address vault) {
        ...
        CovenantVaultV3 deployed = new CovenantVaultV3(usdc, m);
